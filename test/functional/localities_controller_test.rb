...
class LocalitiesControllerTest < ActionController::TestCase
  ...
  test "should create locality" do
    assert_difference('Locality.count') do
      post :create, locality: { id: @locality.id, locality: @locality.locality, township_id: @locality.township_id }
    end
  ...
  test "should update locality" do
    put :update, id: @locality, locality: { id: @locality.id, locality: @locality.locality, township_id: @locality.township_id }
    assert_redirected_to locality_path(assigns(:locality))
  end
