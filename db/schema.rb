...
ActiveRecord::Schema.define(:version => 20130903182945) do
  ...
  create_table "vehicles_criminalgroups", :force => true do |t|
    t.integer  "vehicle_id",        :precision => 38, :scale => 0
  ...
  create_table "weapon_criminalgroups", :force => true do |t|
    t.integer  "weapon_id",         :precision => 38, :scale => 0
    t.integer  "criminal_group_id", :precision => 38, :scale => 0
    t.datetime "created_at",                                       :null => false
    t.datetime "updated_at",                                       :null => false
