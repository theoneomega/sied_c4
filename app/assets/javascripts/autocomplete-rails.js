...
(function(e) {
    ...
    e.fn.railsAutocomplete = function() {
        ...
        _e = e, this.init(_e)
            ...
            function hide_client_info() {
            //SOLO PARA USO ESCUSICO DE BUSQUEDA DE CLIENTES
            ...
            t.delimiter = e(t).attr("data-delimiter") || null, e(t).autocomplete({source: function(n, i) {
                    e.getJSON(e(t).attr("data-autocomplete"), {term: r(n.term)}, function() {
                        arguments[0].length == 0 && (arguments[0] = [], arguments[0][0] = {id: "", label: "no existing match" }, hide_client_info()), e(arguments[0]).each(function(n, r) {
                            var i = {};
                            i[r.id] = r, e(t).data(i)
